...
namespace WBCR\Factory_Templates_105;
...
if ( ! class_exists( 'WBCR\Factory_Templates_105\ImpressiveLite' ) ) {
	...
	abstract class ImpressiveLite extends \WBCR\Factory_Templates_105\Pages\PageBase {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_105_URL . '/pages/templates/impressive-lite/assets/css/impressive-lite.page.template.css' );
		}
		...
		protected function showPageSubMenu() {
			...
			?>
            <div class="w-factory-templates-105-horizontal-menu wp-clearfix">
				<?php foreach ( (array) $page_menu as $page_screen => $page ): ?>
					...
					if ( $page_screen == $this->getResultId() ) {
						$active_tab = ' w-factory-templates-105-horizontal-menu__nav-tab-active';
					}
					?>
                    <a href="<?php echo $page['url'] ?>" id="<?php echo esc_attr( $page_screen ) ?>-tab"
                       class="w-factory-templates-105-horizontal-menu__nav-tab<?php echo esc_attr( $active_tab ) ?>">
