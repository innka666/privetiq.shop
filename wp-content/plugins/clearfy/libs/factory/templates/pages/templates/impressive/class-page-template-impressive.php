...
if ( ! class_exists( 'WBCR\Factory_Templates_105\Impressive' ) ) {
	...
	abstract class Impressive extends \Wbcr_FactoryPages453_AdminPage {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_105_URL . '/pages/templates/impressive/assets/css/impressive.page.template.css' );
		}
		...
		public function flushCacheAndRulesAction() {
			...
			if ( class_exists( 'WBCR\Factory_Templates_105\Helpers' ) ) {
				\WBCR\Factory_Templates_105\Helpers::flushPageCache();
			}
